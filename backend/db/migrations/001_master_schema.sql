...
-- ============================================================================
-- FINANCING_SELECTIONS POLICIES
-- ============================================================================
DROP POLICY IF EXISTS "Users can view their own financing selections" ON public.financing_selections;
CREATE POLICY "Users can view their own financing selections" ON public.financing_selections
  FOR SELECT
  USING (
    EXISTS (
      SELECT 1 FROM public.applications
      WHERE public.applications.id = public.financing_selections.application_id
      AND public.applications.user_id = auth.uid()
    )
  );

DROP POLICY IF EXISTS "Users can insert their own financing selections" ON public.financing_selections;
CREATE POLICY "Users can insert their own financing selections" ON public.financing_selections
  FOR INSERT
  WITH CHECK (
    EXISTS (
      SELECT 1 FROM public.applications
...
DROP POLICY IF EXISTS "Users can update their own financing selections" ON public.financing_selections;
CREATE POLICY "Users can update their own financing selections" ON public.financing_selections
  FOR UPDATE
  USING (
    EXISTS (
      SELECT 1 FROM public.applications
...
DROP POLICY IF EXISTS "Users can delete their own financing selections" ON public.financing_selections;
CREATE POLICY "Users can delete their own financing selections" ON public.financing_selections
  FOR DELETE
  USING (
    EXISTS (
      SELECT 1 FROM public.applications
